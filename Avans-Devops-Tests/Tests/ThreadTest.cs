...
namespace Avans_Devops.Tests
{
    public class CommentTests
    {
        ...
        {
            //Arrange
            BacklogItem backlogItem1 = new BacklogItem(1, 1, 1, "Backlog Item Name 1", PhaseState.ToDo, 1, 1);
            BacklogItem backlogItem2 = new BacklogItem(1, 1, 2, "Backlog Item Name 2", PhaseState.ToDo, 1, 1);
